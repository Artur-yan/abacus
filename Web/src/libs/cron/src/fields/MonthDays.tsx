...
export default function MonthDays(props: MonthDaysProps) {
  ...
  return displayMonthDays ? (
    <div className={internalClassName}>
      ...
      <CustomSelect placeholder={placeholder} value={value} setValue={setValue} unit={UNITS[2]} locale={locale} className={className} disabled={disabled} readOnly={readOnly} leadingZero={leadingZero} period={period} />
    </div>
  ) : null;
}
