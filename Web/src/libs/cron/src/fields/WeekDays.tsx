...
export default function WeekDays(props: WeekDaysProps) {
  ...
  return displayWeekDays ? (
    <div className={internalClassName}>
      {locale.prefixWeekDays !== '' && (period === 'week' || !monthDaysIsDisplayed) && <span>{locale.prefixWeekDays || DEFAULT_LOCALE_EN.prefixWeekDays}</span>}

      {locale.prefixWeekDaysForMonthAndYearPeriod !== '' && period !== 'week' && monthDaysIsDisplayed && <span>{locale.prefixWeekDaysForMonthAndYearPeriod || DEFAULT_LOCALE_EN.prefixWeekDaysForMonthAndYearPeriod}</span>}
